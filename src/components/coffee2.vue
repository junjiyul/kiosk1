    ...
    <div class="choose-m">
      <div >
        <button class="menu-bt m-bt">
          <img alt="menu" class="ice" src="./pic/coffee/콜드브루.png" />
        </button><br><br>콜드브루<br><br>3,300원
      </div>
      <div>
        <button class="menu-bt m-bt">
          <img alt="menu" class="ice" src="./pic/coffee/콜드브루라떼.png" />
        </button><br><br>콜드브루라떼<br><br>3,800원
      </div>
      <div>
        <button class="menu-bt m-bt">
          <img alt="menu" class="ice" src="./pic/coffee/바닐라라떼(ICED).png" />
        </button><br><br>바닐라라떼(ICED)<br><br>3,500원
      </div>
      <div>
        <button class="menu-bt m-bt">
          <img alt="menu" class="hot" src="./pic/coffee/바닐라라떼(HOT).png" />
        </button><br><br>바닐라라떼(HOT)<br><br>3,500원
      </div>
    </div>
    <div class="choose-m">
      <div>
        <button class="menu-bt m-bt">
          <img alt="menu" class="hot" src="./pic/coffee/카푸치노(HOT).png" />
        </button><br><br>카푸치노(HOT)<br><br>3,500원
      </div>
      <div>
        <button class="menu-bt m-bt">
          <img alt="menu" class="ice" src="./pic/coffee/아인슈페너(ICED).png" />
        </button><br><br>아인슈페너(ICED)<br><br>3,500원
      </div>
      <div>
        <button class="menu-bt m-bt">
          <img alt="menu" class="hot" src="./pic/coffee/아인슈페너(HOT).png" />
        </button><br><br>아인슈페너(HOT)<br><br>3,500원
      </div>
    </div>
  </div>
  <div class="right">
