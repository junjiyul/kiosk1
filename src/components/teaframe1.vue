        ...
        <div class="center">
            <div class="choose-m">
                <div>
                    ...
                    </button><br><br>페퍼민트(HOT)<br><br>2,000원
                </div>
                <div>
                    <button class="menu-bt m-bt">
                        <img alt="menu" class="ice" src="./coffee/바닐라라떼(ICED).png" />
                    </button><br><br>머스켓 블렌드(HOT)<br><br>3,500원
                </div>
                <div>
                    <button class="menu-bt m-bt">
                        <img alt="menu" class="ice" src="./coffee/콜드브루라떼.png" />
                    </button><br><br>레몬 사과 블렌드(HOT)<br><br>3,500원
                </div>
                <div>
                    <button class="menu-bt m-bt">
                        <img alt="menu" class="hot" src="./coffee/바닐라라떼(HOT).png" />
                    </button><br><br>히비스커스 블렌드(HOT)<br><br>3,500원
                </div>
            </div>
            <div class="choose-m">
                <div>
                    ...
                    </button><br><br>아쌈(HOT)<br><br>2,000원
                </div>
                <div>
                    <button class="menu-bt m-bt">
                        <img alt="menu" class="ice" src="./coffee/아인슈페너(ICED).png" />
                    </button><br><br>얼그레이(HOT)<br><br>2,000원
                </div>
                <div>
                    <button class="menu-bt m-bt">
                        <img alt="menu" class="ice" src="./coffee/아인슈페너(ICED).png" />
                    </button><br><br>자몽 차(HOT)<br><br>3,500원
                </div>
                <div>
                    <button class="menu-bt m-bt">
                        <img alt="menu" class="ice" src="./coffee/아인슈페너(ICED).png" />
                    </button><br><br>유자 차(HOT)<br><br>3,500원
                </div>
            </div>
        </div>
        <div class="right">
